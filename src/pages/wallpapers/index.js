  ...
  return (
    <WallpapersWrapper>
      ...
      <div className='grid'>
        ...
        <div className='grid-item'><Image src='https://picsum.photos/360/540?radom=27' /></div>
        <div className='grid-item'><Image src='https://picsum.photos/360/440?radom=26' /></div>
        <div className='grid-item'><Image src='https://picsum.photos/360/500?radom=28' /></div>
        ...
        <div className='grid-item'><Image src='https://picsum.photos/360/480?radom=1' /></div>
        <div className='grid-item'><Image src='https://picsum.photos/360/520?radom=2' /></div>
        ...
        <div className='grid-item'><Image src='https://picsum.photos/360/460?radom=32' /></div>
      </div>
      <Divider/>
    </WallpapersWrapper>
  )
